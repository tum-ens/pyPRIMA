...
def load_parameters(param):
    ...
    param["load"] = {"sectors": ['RES', 'COM', 'IND', 'AGR'],
                     "sectors_eurostat": {'Residential': 'RES',
...
def grid_parameters(param):
    ...
    param["grid"] = {"quality": {"voltage": 1,
                                 "wires": 0,
                                 "cables": 0.5,
                                 "frequency": 0,
                                 },
                     "default": {"voltage": 220000, # in Volt
                                 "wires": 1,
                                 "cables": 3,
                                 "frequency": 50,
                                 },
                     # from literature (see CITAVI files: "References for Reactances and SILVersion6")
                     "specific_reactance": {110: 0.39, # in Ohm/km
                                            220: 0.3,
                                            345: 0.3058,
                     ...
                     "loadability": {80: 3, # dimensionless
                                     100: 2.75,
                                     150: 2.5,
                                     200: 2,
                                     250: 1.75,
...
def load_input_paths(paths):
    ...
    paths["profiles"] = {'RES': PathTemp + "Load profiles" + fs + "Lastprofil_Haushalt_H0.xlsx", # CA: "Residential Load Profile_2017_SCE.csv"
                         ...
                         'COM': PathTemp + "Load profiles" + fs + "VDEW-Lastprofile-Gewerbe-Landwirtschaft_G0.csv", # CA: "Small Commercial_Load Profile_2017 SCE.xlsx"
