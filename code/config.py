...
def scope_paths_and_parameters(paths, param):
	...
	*technology* is a dictionary of the technologies (*Storage*, *Prcess*) to be used in the model. The names of the technologies should match the names
    ...
    param["technology"] = {"Storage": ["Battery", "PumSt"],
                           "Process": ["Bioenergy", "Coal", "Gas", "Geothermal", "Hydro", "Lignite", "Nuclear",
                                       "OilOther", "Solar", "WindOff", "WindOn"],
                           }
...
def grid_parameters(param):
    ...
    param["grid"] = {
        ...
        # dummy values??
        "SIL": {10: 0.3, 30: 2.7, 69: 15, 110: 32, 138: 59.4, 220: 175, 345: 504, 380: 602, 500: 1200, 765: 2736,
                1000: 6312},  # in MW
