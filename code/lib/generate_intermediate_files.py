...
def generate_intermittent_supply_timeseries(paths, param):
    ...
    :raise Sub-regions missing: Some sub-regions are not present in the time series file, and will be left null in the output .csv file.
    """
    timecheck('Start')
    Timeseries = None
