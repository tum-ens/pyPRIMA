...
load = {"dict_season": {1:'Winter', 2:'Winter', 3:'Spring/Fall', 4:'Spring/Fall', 5:'Spring/Fall', 6:'Summer',
        ...
        "dict_daytype": {'Monday': 'Working day', 'Tuesday': 'Working day', 'Wednesday': 'Working day',
                         'Thursday': 'Working day', 'Friday': 'Working day', 'Saturday':'Saturday', 'Sunday':'Sunday'},
		# If the data source of the load time series uses different country codes
        "dict_countries": {'AT': 'AT', 'BA': 'BA', 'BE': 'BE', 'BG': 'BG', 'CH': 'CH', 'CY': 'CY', 'CZ': 'CZ', 'DE': 'DE',
		                   'DK': 'DK', 'EE': 'EE', 'ES': 'ES', 'FI': 'FI', 'FR': 'FR', 'GB': 'UK', 'GR': 'EL', 'HR': 'HR',
                           'HU': 'HU', 'IE': 'IE', 'IS': 'IS', 'IT': 'IT', 'LT': 'LT', 'LU': 'LU', 'LV': 'LV', 'ME': 'ME',
                           'MK': 'MK', 'NI': 'UK', 'NL': 'NL', 'NO': 'NO', 'PL': 'PL', 'PT': 'PT', 'RO': 'RO', 'RS': 'RS',
                           'SE': 'SE', 'SI': 'SI', 'SK': 'SK'},
